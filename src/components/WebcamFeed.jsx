...
export default function WebcamFeed({ candidateId, candidateName, sessionId, onViolation, onDisqualify }) {
      ...
      <div style={{ position: 'relative', marginBottom: 24 }}>
        ...
        <div style={styles.loadingIcon}>
          <svg style={{ width: 32, height: 32, color: '#60a5fa' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path style={{ width: 32, height: 32, color: '#60a5fa' }} strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /> 
          </svg>
        </div>
      </div>
  ...
  const captureAndQueueFrame = useCallback(() => {
    ...
    console.log("hello from nishant")
...
// export default function WebcamFeed({ candidateId, candidateName, sessionId, onViolation, onDisqualify }) {
//   console.log("🔥 WebcamFeed DEBUG - Component mounted");
//   console.log("🔥 Props:", { candidateId, candidateName, sessionId });
...
//     processingDot: { width: 10, height: 10, borderRadius: '50%', background: '#3b82f6', marginRight: 8 },
//     icon: { width: 20, height: 20, marginRight: 8 },
//     debugPanel: { position: 'absolute', top: 10, left: 10, background: 'rgba(0,0,0,0.8)', color: '#fff', padding: 8, borderRadius: 4, fontSize: 12, maxWidth: 300, zIndex: 100 }
//   };
...
//   // Simplified frame capture for debugging
//   // const testApiCall = useCallback(async () => {
//   //   if (!candidateId) {
//   //     console.log("🔥 No candidateId, skipping API call");
//   //     return;
//   //   }
...
//   //     console.log("🔥 Test image created:", testImage.substring(0, 100) + "...");
//   //     console.log("🔥 Calling postJSON with endpoint '/frames/'");
//   //     console.log("🔥 Full URL would be:", API_BASE + "/frames/");
      
//   //     const response = await postJSON("/frames/", { 
//   //       candidate_id: candidateId, 
//   //       image: testImage
//   //     });
...
//   // Test button for manual API testing
//   // const handleTestApi = () => {
...
//       console.log("🔥 Frame captured, size:", image.length);
...
//   useEffect(() => {
//     console.log("🔥 Effect triggered - isStreaming:", isStreaming, "candidateId:", candidateId);
    
//     if (!isStreaming || !candidateId) {
//       console.log("🔥 Not starting frame capture");
//       return;
//     }

//     console.log("🔥 Starting frame capture interval");
    
//     // Start capturing frames every 2 seconds for debugging
//     const interval = setInterval(() => {
//       console.log("🔥 Interval tick - attempting frame capture");
//       captureFrame();
//     }, 2000);

//     // Initial capture after 1 second
//     setTimeout(() => {
//       console.log("🔥 Initial frame capture");
//       captureFrame();
//     }, 1000);
...
//     };
//   }, [isStreaming, candidateId, captureFrame]);

//   // const renderDebugInfo = () => (
//   //   <div style={styles.debugPanel}>
//   //     <div><strong>Debug Info:</strong></div>
//   //     <div>Streaming: {isStreaming ? 'Yes' : 'No'}</div>
//   //     <div>CandidateId: {candidateId || 'None'}</div>
//   //     <div>Frames Captured: {debugInfo.framesCaptured}</div>
//   //     <div>API Calls Made: {debugInfo.apiCallsMade}</div>
//   //     <div>Last API Call: {debugInfo.lastApiCall || 'None'}</div>
//   //     <div>Last Error: {debugInfo.lastError || 'None'}</div>
//   //     <div>API_BASE: {API_BASE}</div>
//   //     <button 
//   //       onClick={handleTestApi}
//   //       style={{...styles.btn, ...styles.btnPrimary, marginTop: 8, fontSize: 10, padding: '4px 8px'}}
//   //     >
//   //       Test API Call
//   //     </button>
//   //   </div>
...
//         <div style={styles.loadingIcon}>
//           <svg style={{ width: 32, height: 32, color: '#60a5fa' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 002 2z" />
//           </svg>
//         </div>
//       </div>
//       <h3 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8 }}>Initializing Camera</h3>
