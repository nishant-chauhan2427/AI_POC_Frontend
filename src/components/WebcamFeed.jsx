...
export default function WebcamFeed({
    ...
    return (
      <div style={styles.panelBase}>
        ...
        <button
          ...
          style={{
            ...styles.btn,
            ...(isProcessing ? styles.btnDisabled : styles.btnPrimary),
          }}
  ...
  const renderLoading = () => (
    <div className="bg-[#0f172a]/90   border border-white/10 rounded-2xl p-8 text-center max-w-xl mx-auto ">
      <div className="relative mb-6 flex items-center justify-center">
        {/* Outer ring */}
        <div className="absolute w-20 h-20 rounded-full border-4 border-blue-500/30 animate-spin"></div>

        {/* Inner ring */}
        <div className="absolute w-14 h-14 rounded-full border-4 border-blue-400 border-t-transparent animate-spin"></div>
      ...
      <p className="text-gray-400 text-sm max-w-md mx-auto">
        Please wait while we set up your camera. Make sure to allow camera
